...
- **Clip-path reveals**: Text or images revealed by an expanding `clip-path`.
- **Parallax depth**: Background layers moving at different scroll speeds.
...
- [ ] Cursor customised where meaningful
...
### Navigation
- Fixed or sticky nav should collapse gracefully.
